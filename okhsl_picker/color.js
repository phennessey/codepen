...
// Re-export things main.js may need directly
export { OKLab, OKLCH, DisplayP3, sRGB, DisplayP3Gamut, sRGBGamut };
...
/**
 * Compute Display-P3 and sRGB CSS representations for a color.
 * Returns { p3Str, p3Css, srgbCss, hex, outOfSRGB }.
 */
...
/**
 * Build a closed SVG path from polar samples around a disc.
 * radiusFn(hue01) → pixel radius for that hue.
 */
...
/**
 * Fill an ImageData buffer with the OKHSL disc at a given toed lightness.
 * Writes directly into `imageData.data`.
 */
...
/**
 * Fill an ImageData buffer with the lightbar gradient for (h, s).
 */
...
/**
 * Compute the SVG path string for the sRGB boundary on the disc at a given lr.
 */
...
/**
 * Compute gamut-boundary stroke colour & opacity for a given lightness L.
 */
...
/**
 * Return a display-p3 CSS color string for the given OKLab lightness.
 */
...
/**
 * Returns an array of [indexA, indexB] edges from a Delaunay triangulation
 * of the given {x, y} point array.
 */
